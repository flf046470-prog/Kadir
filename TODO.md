...
`npm run verify` = lint + asset/pack gates + typecheck + **1084 tests** + all three builds +
...
- [x] **21 · QA** — 1084 automated tests; browser smoke test on desktop and mobile viewports;
