...
`npm run verify` = lint + asset/pack gates + typecheck + **1065 tests** + all three builds +
...
- [x] **21 · QA** — 1065 automated tests; browser smoke test on desktop and mobile viewports;
