...
`npm run verify` = lint + asset/pack gates + typecheck + **1085 tests** + all three builds +
...
- [x] **21 · QA** — 1085 automated tests; browser smoke test on desktop and mobile viewports;
